...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		People francisco = new People(
				...
				new Adress(AdressType.PHYSICAL, "08080-000", "São Paulo", "Santo André", "Rua Central", 350, "Apt 6", "Vila Amélia"),
		...
		People ana = new People(
				...
				"Ana",
				"White", 
				sdf.parse("02/05/2002"),
				new Adress(AdressType.DELIVERY, "08080-000", "São Paulo", "Guarulhos", "Rua Jacobina", 1000, "", "Vila Pires"),
